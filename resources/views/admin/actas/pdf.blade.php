...
<head>
    ...
    <style>
        @page {
            size: landscape; /* Configura el formato horizontal */
            margin: 20px;
        }
        ...
        .header-text {
            text-align: center;
            vertical-align: middle;
            width: 74%; /* Hace que ocupe todo el espacio disponible */
        }
        ...
        h2, h3 {
            margin: 5px 0; /* Ajusta márgenes para un mejor centrado */
        }
    </style>
</head>
<body>
